  ...
  admin: {
    ...
    settings: {
      ...
      payment: {
        ...
        field_appSecret: 'App Secret',
        field_expire: 'Expire seconds',
        ...
        field_xorpayApiBaseHint: 'Default is https://xorpay.com. Change only when using a XorPay-compatible private gateway.',
        field_xorpayExpireHint: 'Payment order expiry in seconds. Default is 7200.',
